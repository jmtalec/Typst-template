...
#import "tf-environment.typ": *
#import "tf-utils.typ": *
#import "tf-template-info.typ": *
#import "tf-components.typ": *
...
#let tf-article(
  ...
  // Text
  set text(size: font-size.normal, font: "Knowledge")
  ...
  show math.equation: set text(font:mathfont, size: font-size.math)
  ...
  // bibliography
  set bibliography(title: "Reférences", style: "elsevier-with-titles")
